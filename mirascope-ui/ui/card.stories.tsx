...
import { Input } from "@/mirascope-ui/ui/input";
import { Label } from "@/mirascope-ui/ui/label";
...
export const NestedCards: Story = {
        ...
        <Card>
          ...
          <CardContent className="pb-2">
            <div className="flex items-center justify-between">
              ...
              <p className="text-muted-foreground text-sm">60%</p>
            </div>
            <div className="bg-secondary mt-2 h-2 w-full rounded-full">
  ...
  parameters: {
    docs: {
      description: {
        story: "A card with nested card components for hierarchical information.",
      },
    },
  },
};
    ...
    <Card className="w-[300px]">
      ...
      <CardContent className="text-center">
        ...
        <ul className="mt-6 space-y-2 text-left">
          ...
          <li className="flex items-center">
            <UserRound className="text-primary mr-2 h-4 w-4" />
...
export const InteractiveCard: Story = {
  render: () => (
    <Card className="w-[350px] cursor-pointer transition-all hover:-translate-y-1 hover:shadow-lg">
      <CardHeader>
        <div className="flex items-center justify-between">
...
export const HorizontalCard: Story = {
  render: () => (
    <Card className="flex w-[600px] flex-row overflow-hidden">
      ...
      <div className="w-2/3">
        ...
        <CardContent>
          <p>This card uses a horizontal layout with an image or icon section on the left.</p>
        </CardContent>
        <CardFooter className="flex justify-end">
  ...
  parameters: {
    docs: {
      description: {
        story: "A card with a horizontal layout instead of the default vertical arrangement.",
      },
    },
  },
};
...
export const CardGrid: Story = {
  render: () => (
    <div className="grid w-[650px] grid-cols-2 gap-4">
